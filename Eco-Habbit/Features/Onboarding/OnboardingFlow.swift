...
struct OnboardingFlow: View {
    ...
    @State private var categories: Set<HabitCategory> = []
    ...
    var body: some View {
        ZStack {
            ...
            default: PermissionsStep(permissions: permissions) { finish() }
            }
        }
...
// MARK: - Step 3 · Favourite categories

private struct CategoryPickStep: View {
    @Binding var selection: Set<HabitCategory>
    let next: () -> Void
    ...
    var body: some View {
        OnboardingScaffold(
            ...
            subtitle: "We'll surface habits from these categories first.",
...
private struct PermissionsStep: View {
    ...
    var body: some View {
        OnboardingScaffold(
            ...
            subtitle: "Optional — you can turn this on later.",
            ...
            VStack(spacing: 14) {
                PermissionCard(
                    ...
                    title: "Camera",
                    detail: "Needed to visually search for actions — no photos are stored.",
