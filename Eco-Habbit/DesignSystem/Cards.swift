...
//    private let shadow: String
    ...
    init(title: String, caption: String, icon: String, background: Color, tint: Color, /*shadow: String*/ action: @escaping () -> Void = {}){
        self.title = title
...
//                    }
                Spacer()
                NavigateButton(background: tint, direction: .right, action: action)
            }
